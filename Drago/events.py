...
from Drago import MONGO_DB_URI
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        path = Path(f"Drago/modules/{shortname}.py")
        name = "Drago.modules.{}".format(shortname)
        ...
        spec.loader.exec_module(mod)
        sys.modules["Drago.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "Drago/modules/*.py"
