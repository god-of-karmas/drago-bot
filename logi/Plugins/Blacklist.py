...
from logi.Database import blacklist_chat, blacklisted_chats, whitelist_chat
...
@app.on_message(filters.command("blacklistchat") & filters.user(DRAGONS))
...
@app.on_message(filters.command("whitelistchat") & filters.user(DRAGONS))
