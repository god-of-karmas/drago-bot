...
from Drago import DRAGONS, app, db_mem, random_assistant
...
@app.on_message(filters.command("activevc") & filters.user(DRAGONS))
async def activevc(_, message: Message):
    served_chats = []
    try:
...
@app.on_message(filters.command("activevideo") & filters.user(DRAGONS))
...
@app.on_message(filters.command("joinassistant") & filters.user(DRAGONS))
...
@app.on_message(filters.command("leavebot") & filters.user(DRAGONS))
...
@app.on_message(filters.command("leaveassistant") & filters.user(DRAGONS))
